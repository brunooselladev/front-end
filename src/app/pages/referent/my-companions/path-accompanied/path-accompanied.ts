...
@Component({
  selector: 'app-path-accompanied',
  imports: [CommonModule, SidebarComponent, NavbarComponent, TrayectoriaComponent],
  templateUrl: './path-accompanied.html',
  styleUrl: './path-accompanied.scss'
})
export class PathAccompanied implements OnInit {
